...
# Contributions
Rayleen Lewis contributed to this exercise.
...
# I added two columns "Age" and "Employment Status" to the data sheet. "Age" includes numeric values and "Employment Status" includes "Employed", "Unemployed", and "Retired".
...
This is a boxplot with employment status on the x-axis, and height on the y-axis. The figure shows that the median height of unemployed people is higher than employed people than retired people.
```{r}
#| label: boxplot
#| fig-cap: "Distribution of Height by Employment Status."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","boxplotrl.png"))
```


This is a scatterplot with weight on the x-axis and age on the y-axis. There seems to be a negative trend between weight and age.
```{r}
#| label: scatterplot
#| fig-cap: "Correlation between Weight and Age."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","scatterplotrl.png"))
```

This is a linear model with Height as outcome and Age and Employment Status as predictors. From the table, both age and employment don't display significant assosiation with height.
```{r}
#| label: table3
#| tbl-cap: "Linear model with Height as outcome and Age and Employment Status as predictors."
#| echo: FALSE
